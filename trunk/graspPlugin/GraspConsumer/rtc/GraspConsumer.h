...
#ifndef GRASPCONSUMER_H
#define GRASPCONSUMER_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  GraspConsumer(RTC::Manager* manager);
 ...
 protected:
  ...
  /*!
   */
  RTC::CorbaPort m_PlannStartPortPort;
  /*!
   */
...
extern "C"
{
  DLL_EXPORT void GraspConsumerInit(RTC::Manager* manager);
};

#endif // GRASPCONSUMER_H
